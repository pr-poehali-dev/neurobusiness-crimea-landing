...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-open-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="font-montserrat font-bold text-navy-900">НейроБизнес Крым</span>
            </div>
      ...
      {/* Hero Section */}
      <section className="pt-16 min-h-screen bg-gradient-to-br from-navy-900 via-navy-800 to-primary relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center min-h-screen">
          <div className="text-center w-full">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 animate-fade-in max-w-4xl mx-auto">
            ...
            {/* Countdown Timer */}
            <div className="mb-12">
              <p className="text-gold-500 text-lg mb-4">Early Bird заканчивается через:</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-500 text-navy-900 font-semibold text-lg px-8 py-4">
                Купить билет Early Bird за 6 000 ₽
              </Button>
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-navy-900 text-lg px-8 py-4">
                Смотреть программу
              </Button>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-montserrat font-bold text-3xl md:text-4xl text-navy-900 mb-4">
            ...
            {[
              ...
              <Card key={index} className="hover:shadow-lg transition-all duration-300 hover:-translate-y-2 border-0 bg-white">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-montserrat font-semibold text-xl text-navy-900 mb-2">
                    {item.title}
                  </h3>
            ...
            {[
              ...
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-primary/30">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-montserrat font-semibold text-xl text-navy-900 mb-1">
                    {item.title}
                  </h3>
                  <p className="text-sm text-gray-500 mb-3">{item.subtitle}</p>
                  <p className="text-gray-600 mb-4">{item.description}</p>
                  <a href="#" className="text-primary hover:text-blue-700 font-medium flex items-center gap-1 group-hover:gap-2 transition-all">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={index} className="flex items-start gap-6 p-6 bg-white rounded-lg shadow-sm">
                  <div className="bg-primary text-white px-4 py-2 rounded-lg font-semibold min-w-fit">
                    {item.time}
                  </div>
                  <div>
                    <h3 className="font-montserrat font-semibold text-xl text-navy-900 mb-2">
            ...
            {[
              ...
              <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-primary font-medium mb-2">{speaker.company}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <Card key={index} className={`relative ${ticket.popular ? 'ring-2 ring-gold-500' : ''} bg-white`}>
                {ticket.popular && (
                  <Badge className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gold-500 text-navy-900">
                    ПОПУЛЯРНЫЙ
                  </Badge>
                )}
                <CardContent className="p-6 text-center">
                  <h3 className="font-montserrat font-semibold text-xl text-navy-900 mb-4">
                    {ticket.name}
                  </h3>
                  <div className="mb-6">
                    ...
                    <div className="text-3xl font-bold text-navy-900">{ticket.price}</div>
                  </div>
                  ...
                  <Button className={`w-full ${ticket.popular ? 'bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-500 text-navy-900' : 'bg-primary hover:bg-blue-700'}`}>
                    Купить билет
                  </Button>
                </CardContent>
              </Card>
      ...
      <footer className="bg-navy-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-blue-800 mt-8 pt-8 text-center text-blue-200">
            <p>&copy; 2024 НейроБизнес Крым. Все права защищены.</p>
          </div>
        </div>
      </footer>
    </div>
